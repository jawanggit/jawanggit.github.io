...
<h1> Chapter 5 Document Object Model (Javascript) </h1>
<h2> Key Points:</h2>
<ul>
<li>specifies how browsers should create a model of an HTML page and how Javascript can access and update the contents of a web page</li>
<li>example of DOM tree on pg 187 and link to example on google:</li>
![](https://www.w3schools.com/js/pic_htmltree.gif)
<li>From an element node, you can access and update its content using properties such as textContent and innerHTML or using DOM manipulation techniques</li>
<li>An element node can contain multiple tests nodes and child elements that are siblings of each other</li>
</ul>
